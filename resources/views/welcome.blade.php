...
<head>
    ...
    <title>E-Commerece Web site</title>
    ...
    <link rel="shortcut icon" href="{{asset('backend/images/ico/favicon.ico')}}">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset('backend/images/ico/apple-touch-icon-144-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{asset('backend/images/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{asset('backend/images/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{asset('backendimages/ico/apple-touch-icon-57-precomposed.png')}}">
...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{url('/')}}"><img src="{{asset('backend/images/home/images.jpg')}}" alt="" /></a>
						</div>
						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
							   ...
							   <li><a href="{{url('payment')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
							    @else
								<li><a href="{{url('loginCheck')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								@endif
							

								<li><a href="{{url('/showCart')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                            ...
                            <?php if($customer_id != NULL) {?>
								...
								<?php } else{ ?>
								<li><a href="{{url('loginCheck')}}"><i class="fa fa-lock"></i> Login</a></li>
								<?php }?>
							</ul>
						</div>
					</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
							   ...
							   @else
								<li><a href="{{url('loginCheck')}}"> Checkout</a></li>
								@endif
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<?php
								$publish_category=DB:: table('category')->where('publication_status',1)->get();
								
								?>
							@foreach($publish_category as $rows)
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{url('/CategoryByproduct/'.$rows->id)}}">{{$rows->category_name}}</a></h4>
								</div>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<?php
								$publish_manufacture=DB::table('manufacture')->where('publication_status',1)->get();
								
								?>
								<ul class="nav nav-pills nav-stacked">
                                   @foreach($publish_manufacture as  $row)
									<li><a href="{{url('/ManufactureByproduct/'.$row->manufacture_id)}}"> <span class="pull-right"></span>{{$row->manufacture_name}}</a></li>
									@endforeach
								</ul>
							</div>
						</div><!--/brands_products-->
	...
	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							@foreach($publish_category as $rows)
							<ul class="nav nav-pills nav-stacked">
								<li><a href="{{url('/CategoryByproduct/'.$rows->id)}}">{{$rows->category_name}}</a></li>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2020 E-Commerce Inc. All rights reserved.</p>
