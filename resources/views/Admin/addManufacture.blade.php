			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Manufactures Items</h2>
						<div class="box-icon">
						...
						<form class="form-horizontal" action="{{url('saveManufacture')}}" method="post">
						  ...
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Manufacture Descrption</label>
							  <div class="controls">
                            ...
                            <div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<input type="checkbox" name="publication_status" value="" >
							  </div>
                            </div>
